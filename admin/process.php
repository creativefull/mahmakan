...
$config["destination_folder"]			= 'DocImage/'; //upload directory ends with / (slash)
$config["thumbnail_destination_folder"]		= 'DocImage/'; //upload directory ends with / (slash)
$config["upload_url"] 				= "DocImage/"; 
